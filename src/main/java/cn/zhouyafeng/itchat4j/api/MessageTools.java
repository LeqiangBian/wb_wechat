...
import cn.zhouyafeng.itchat4j.test.ChatRoomMember;
...
public class MessageTools {
    ...
    public static void webWxSendMsg(int msgType, String content, String toUserName , int scene) {
        ...
        try {
            ...
            LOG.info("webWxSendMsg", e.toString());
        }
     ...
     * 创建房间
     */
    public static void createChatRoom(ChatRoomMember[] members, String topic) {


        String url = String.format(URLEnum.WEB_WX_POST_CREATECHATROOM.getUrl(), core.getLoginInfo().get("url"),
//                core.getLoginInfo().get("pass_ticket"),
                String.valueOf(System.currentTimeMillis()));

        JSONObject body = new JSONObject();
        body.put("BaseRequest", core.getParamMap().get("BaseRequest"));
        body.put("MemberCount", members.length);
